        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">Rocket</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">Jedi</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">Robot</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">Astronaut</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="link-text">Moon</span>
            </a>
          </li>
        </ul>
      </nav>
